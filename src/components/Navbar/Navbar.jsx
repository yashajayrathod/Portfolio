    ...
    <nav  className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='hidden md:flex space-x-4'>
          <a href="https://github.com/yashajayrathod" target='_blank' rel='noopener noreferre' className='text-gray-300 hover:text-[#8245ec]'>
            <FaGithub size={24}/>
          </a>
          <a href="https://www.linkedin.com/in/yash-rathod-7a0a05211/" target='_blank' rel='noopener noreferre' className='text-gray-300 hover:text-[#8245ec]'>
            <FaLinkedin size={24}/>
          </a>
